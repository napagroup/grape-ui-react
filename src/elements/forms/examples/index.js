...
export const cantHardlyWaitAssistiveText = <Link href="https://www.youtube.com/watch?v=siiylkcrnhw" target="_blank">The Replacements - Can&#39;t Hardly Wait</Link>;

export const rogueOptions = [
...
export const princeSongOptions = [
