...
const AlertComponent = (_ref2) => {
  let alertAction = _ref2.alertAction,
      ...
      px = _ref2.px,
      py = _ref2.py,
      props = (0, _objectWithoutProperties2.default)(_ref2, ["alertAction", "alertActionProps", "children", "color", "flexContainerProps", "p", "pb", "pl", "pr", "pt", "px", "py"]);
  const textProps = {
    color
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_grid.Box, (0, _componentHelpers.removeSomeProps)(props, [...(0, _keys.default)(_utils.alertPropTypes), 'closeToast']), /*#__PURE__*/_react.default.createElement(_grid.Flex, (0, _extends2.default)({}, flexContainerProps, paddingProps), getChildren(propsForChildren), getActionButton(propsForActionButton)));
};
