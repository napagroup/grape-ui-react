...
const defaultTableStylesBasePropTypes = _objectSpread(_objectSpread(_objectSpread({}, _propTypes2.default.border), _propTypes2.default.layout), _propTypes2.default.space);
...
const tablePropTypes = _objectSpread(_objectSpread({}, _styledHelpers.typography.propTypes), defaultTableStylesBasePropTypes);

exports.tablePropTypes = tablePropTypes;
const tableBodyPropTypes = {};
exports.tableBodyPropTypes = tableBodyPropTypes;

const tableCellPropTypes = _objectSpread(_objectSpread({}, defaultTableStylesBasePropTypes), _propTypes2.default.fontWeight);

exports.tableCellPropTypes = tableCellPropTypes;

const tableHeadPropTypes = _objectSpread(_objectSpread({}, defaultTableStylesBasePropTypes), _propTypes2.default.fontWeight);
...
const tableWrapperPropTypes = _objectSpread(_objectSpread({}, _styledHelpers.typography.propTypes), _propTypes2.default.border);
