...
const trNthChild = props => {
  ...
  const tableStriped = props.tableStriped;
...
const StyledTableBody = (0, _styledComponents.default)(StyledTableBodyComponent)(_templateObject(), _.defaultTableStylesBase, _styledHelpers.colorCore, trNthChild);
exports.StyledTableBody = StyledTableBody;
StyledTableBody.propTypes = _objectSpread(_objectSpread({}, _.tableBodyPropTypes), {}, {
...
StyledTableBody.defaultProps = _objectSpread(_objectSpread({}, _.defaultTableBodyProps), {}, {
  tableStriped: false
});