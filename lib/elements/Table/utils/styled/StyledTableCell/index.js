...
StyledTableHead.propTypes = _objectSpread(_objectSpread({}, _.tableHeadPropTypes), {}, {
  children: _propTypes.default.node,
  tag: _propTypes.default.node
});
StyledTableHead.defaultProps = _objectSpread(_objectSpread({}, _.defaultTableHeadProps), {}, {
  children: '',
  tag: 'th'
});