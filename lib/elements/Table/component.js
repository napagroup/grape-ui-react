...
const createTableOptions = props => {
  ...
  if (manual) {
    ...
    tableOptions.initialState = _objectSpread({}, tableOptions.initialState);
  }
...
function TableComponent(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_grid.Box, wrapperProps, /*#__PURE__*/_react.default.createElement(_grid.Flex, {
    ...
    isHidden: !showToggleHideColumns
    ...
    isHidden: !tableViewState.paginationTop.visible
  ...
  })), /*#__PURE__*/_react.default.createElement(_utils2.StyledTableResponsiveWrapper, {
    progress: progress,
    progressPlacement: progressPlacement,
    progressProps: progressProps,
    showProgress: showProgress || loading
  }, /*#__PURE__*/_react.default.createElement(_utils2.StyledTable, (0, _extends2.default)({}, tableProps, getTableProps()), /*#__PURE__*/_react.default.createElement(_utils2.StyledTableHeader, tableHeaderProps, (0, _map.default)(headerGroups).call(headerGroups, (headerGroup, headerGroupIndex) => {
    var _context2;
    ...
    isHidden: !tableViewState.paginationBottom.visible
  }, /*#__PURE__*/_react.default.createElement(_Paginator.Paginator, {
    canNextPage: canNextPage,
    canPreviousPage: canPreviousPage,
    gotoPage: gotoPage,
...
TableComponent.propTypes = _objectSpread({}, _Progress.getProgressPropTypes, {
...
TableComponent.defaultProps = _objectSpread({}, _Progress.getProgressDefaultProps, {
