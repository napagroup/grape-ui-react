...
const CheckboxInputComponent = (0, _styledComponents.default)('input')(_templateObject(), _styledSystem.space);
...
const CheckboxInput = props => {
  ...
  }, propsForCheckboxLabel), /*#__PURE__*/_react.default.createElement(_grid.Flex, {
    alignItems: "baseline"
  }, /*#__PURE__*/_react.default.createElement(CheckboxInputComponent, (0, _extends2.default)({
    key: option.label,
    ref: inputRef,
    disabled: disabled,
    id: id || name,
    type: "checkbox"
  }, propsForCheckboxControl)), /*#__PURE__*/_react.default.createElement(_grid.Box, null, option.label)));
};
