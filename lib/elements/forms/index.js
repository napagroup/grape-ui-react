...
_forEachInstanceProperty(_context4 = _Object$keys(_RadioField)).call(_context4, function (key) {
  if (key === "default" || key === "__esModule") return;
...
_forEachInstanceProperty(_context5 = _Object$keys(_SelectField)).call(_context5, function (key) {
  if (key === "default" || key === "__esModule") return;
...
_forEachInstanceProperty(_context6 = _Object$keys(_TextField)).call(_context6, function (key) {
  if (key === "default" || key === "__esModule") return;
