...
const controlStylesTextField = props => !props.validationError ? (0, _styledHelpers.controlStyles)(props) : (0, _styledHelpers.controlStyles)(_objectSpread(_objectSpread({}, props), {}, {
...
TextFieldComponent.propTypes = _objectSpread(_objectSpread({
...
const TextField = props => {
  const activeColor = props.activeColor,
        ...
        otherProps = (0, _objectWithoutProperties2.default)(props, ["activeColor", "assistiveTextProps", "bg", "controlGroupProps", "controlId", "controlLabelProps", "formStyle", "isRequired", "labelText", "name", "validationError"]);
