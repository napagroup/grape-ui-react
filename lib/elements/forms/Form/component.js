...
const formComponentPropsToRemove = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _propTypes2.default.flexbox), _propTypes2.default.layout), _propTypes2.default.position), _propTypes2.default.space), {}, {
  formInline: false
});

const applyFormStyleToChild = (child, formStyleFromParent) => {
  const formStyle = child.props.formStyle;
