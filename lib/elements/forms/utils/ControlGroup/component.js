...
const renderControlGroupLabel = propsFromControlGroup => {
  ...
  const labelProps = _objectSpread(_objectSpread({
    activeColor,
    bg: bgColorFromProps
  }, controlLabelProps), {}, {
    disabled,
...
ControlGroupComponent.propTypes = _objectSpread(_objectSpread(_objectSpread({}, _styledHelpers.spaceProps.propTypes), _styledHelpers.typography.propTypes), {}, {
