...
const fontSizeAssistiveText = props => (0, _styledHelpers.fontSizeCore)(_objectSpread(_objectSpread({}, props), {}, {
  sm: true
}));
...
AssistiveText.propTypes = _objectSpread(_objectSpread({}, _styledHelpers.spaceProps.propTypes), _styledHelpers.typography.propTypes);
AssistiveText.defaultProps = _objectSpread(_objectSpread({}, _styledHelpers.defaultStylesBase), {}, {
  color: 'gray',
  px: 3
});
/** @component */