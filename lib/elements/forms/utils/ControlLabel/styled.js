...
const colorLabel = props => (0, _styledHelpers.colorCore)(_objectSpread(_objectSpread({}, props), {}, {
  color: !props.validationError ? props.color : 'brandDanger'
}));

const fontSizeLabel = props => (0, _styledHelpers.fontSizeCore)(_objectSpread(_objectSpread({}, props), {}, {
  sm: true
}));
...
ControlLabel.propTypes = _objectSpread(_objectSpread({
...
ControlLabel.defaultProps = _objectSpread(_objectSpread({}, _styledHelpers.defaultStylesBase), {}, {
