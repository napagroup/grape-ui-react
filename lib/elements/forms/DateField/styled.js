...
const renderDateFieldComponent = dateFieldProps => {
  ...
  const controlProps = _objectSpread(_objectSpread({}, inputProps), {}, {
    disabled,
    ref: inputRef
  });
...
const DateField = props => {
  ...
  const newControlColorProps = _objectSpread(_objectSpread({}, _props.defaultControlColorProps), controlColorProps);

  const newDayPickerProps = _objectSpread(_objectSpread({}, _props.defaultDayPickerProps), {}, {
...
DateField.propTypes = _objectSpread(_objectSpread(_objectSpread(_objectSpread({
