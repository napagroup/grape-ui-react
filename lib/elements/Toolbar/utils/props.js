...
const toolbarPropTypes = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _propTypes2.default.background), _propTypes2.default.border), _propTypes2.default.color), _propTypes2.default.flexbox), _propTypes2.default.layout), _propTypes2.default.position), _propTypes2.default.shadow), _propTypes2.default.space), {}, {
