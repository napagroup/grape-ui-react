...
var Button = exports.Button = (0, _styledComponents2.default)(_component.ButtonComponent)(_templateObject, _styledSystem.alignContent, _styledSystem.alignItems, _styledSystem.alignSelf, _utils.bgColor, _utils.borderForButton, _styledSystem.borderWidth, _styledSystem.bottom, _styledSystem.display, _styledSystem.flexBasis, _styledSystem.flexDirection, _styledSystem.flexWrap, _textStyles.getColor, _textStyles.getFontSize, _styledSystem.height, _styledSystem.justifyContent, _styledSystem.left, _styledSystem.letterSpacing, _utils.lineHeightForButton, _styledSystem.maxHeight, _styledSystem.maxWidth, _styledSystem.minHeight, _styledSystem.minWidth, _utils.positionForButton, _styledSystem.ratio, _styledSystem.right, _styledSystem.size, _styledSystem.space, _styledSystem.textAlign, _styledSystem.top, _styledSystem.width, _styledSystem.zIndex);

Button.propTypes = Object.assign({}, _styledSystem.alignContent.propTypes, _styledSystem.alignItems.propTypes, _styledSystem.alignSelf.propTypes, {
  bgColor: _propTypes2.default.string
}, _styledSystem.border.propTypes, _styledSystem.borderWidth.propTypes, _styledSystem.bottom.propTypes, {
...
}, _styledSystem.ratio.propTypes, _styledSystem.right.propTypes, _styledSystem.size.propTypes, _styledSystem.space.propTypes, _styledSystem.textAlign.propTypes, _styledSystem.top.propTypes, _styledSystem.width.propTypes, _styledSystem.zIndex.propTypes);
