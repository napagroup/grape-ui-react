...
}, _styledSystem.top.propTypes, _textStyles.typography.propTypes, _styledSystem.width.propTypes, _styledSystem.zIndex.propTypes);

var propsToTrimForLink = Object.assign({}, _styledSystem.alignContent.propTypes, _styledSystem.alignItems.propTypes, _styledSystem.alignSelf.propTypes, {
  bgColor: ''
}, _styledSystem.border.propTypes, _styledSystem.borderWidth.propTypes, _styledSystem.bottom.propTypes, _styledSystem.color.propTypes, {
  contained: false
...
var ButtonComponent = function ButtonComponent(_ref) {
  ...
  if (href) {
    ...
    output = _react2.default.createElement(
      'button',
      (0, _componentHelpers.removeSomeProps)(props, Object.keys(propsToTrimForButton)),
      ' ',
      children,
      ' '
    );
