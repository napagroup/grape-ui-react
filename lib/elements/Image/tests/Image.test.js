...
describe('Image Component base', function () {
  ...
  it('should return a Image object with width applied', function () {
    var component = (0, _enzyme.mount)(_react2.default.createElement(_.Image, { alt: 'blue flower', src: 'https://images.pexels.com/photos/67636/rose-blue-flower-rose-blooms-67636.jpeg', width: [1, 3 / 4, 2 / 3, 1 / 2] }));
    expect((0, _enzymeToJson2.default)(component.find('Img'))).toMatchSnapshot();
  });
});