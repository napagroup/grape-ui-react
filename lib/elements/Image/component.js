...
const componentPropsToRemove = _objectSpread({}, _styledHelpers.layoutProps.propTypes, {}, _styledHelpers.spaceProps.propTypes);

const ImageComponent = (_ref) => {
  let alt = _ref.alt,
      props = (0, _objectWithoutProperties2.default)(_ref, ["alt"]);
  return /*#__PURE__*/_react.default.createElement(_reactImage.default, (0, _extends2.default)({
    alt: alt
