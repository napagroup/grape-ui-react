...
const componentPropsToRemove = _objectSpread(_objectSpread(_objectSpread({}, _propTypes2.default.border), _propTypes2.default.layout), _propTypes2.default.space);
