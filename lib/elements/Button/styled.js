...
var borderButton = function borderButton(props) {
  return (0, _styledSystem.border)(Object.assign({}, props, {
...
var boxShadowButtonMemoized = function boxShadowButtonMemoized() {
  ...
  return function (props) {
    return (0, _styledSystem.boxShadow)(Object.assign({}, props, {
...
var Button = exports.Button = (0, _styledComponents2.default)(_component.ButtonComponent)(_templateObject, _styledSystem.alignContent, _styledSystem.alignItems, _styledSystem.alignSelf, borderButton, _styledSystem.borderRadius, _styledSystem.borderWidth, boxShadowButtonMemoized(), _styledSystem.bottom, _styledSystem.buttonStyle, _styledHelpers.colorCore, _styledSystem.display, _styledSystem.flexBasis, _styledSystem.flexDirection, _styledSystem.flexWrap, _styledHelpers.fontFamilyCore, _styledHelpers.fontSizeCore, _styledHelpers.fontStyleCore, _styledSystem.fontWeight, _styledSystem.height, _styledSystem.justifyContent, _styledSystem.left, _styledHelpers.letterSpacingCore, _utils.lineHeightButton, _styledSystem.maxHeight, _styledSystem.maxWidth, _styledSystem.minHeight, _styledSystem.minWidth, _utils.positionButton, _styledSystem.right, scaleButton, _styledSystem.size, _styledHelpers.textAlignCore, _styledHelpers.textDecorationCore, _styledSystem.top, _styledSystem.width, _styledSystem.zIndex, boxShadowButtonMemoized('02'));

Button.propTypes = Object.assign({}, _styledSystem.alignContent.propTypes, _styledSystem.alignItems.propTypes, _styledSystem.alignSelf.propTypes, _styledSystem.border.propTypes, _styledSystem.borderRadius.propTypes, _styledSystem.bottom.propTypes, _styledSystem.boxShadow.propTypes, {
...
Button.defaultProps = Object.assign({}, _styledHelpers.defaultStylesBase, {
  bg: null,
  border: '1px solid ' + (0, _styledHelpers.resolveColor)('gray.light'),
  borderRadius: '4px',
  color: null,
  contained: false,
