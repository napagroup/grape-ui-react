...
const borderButton = props => (0, _styledSystem.border)(_objectSpread(_objectSpread({}, props), {}, {
  border: props.outline ? props.border : '0'
}));

const boxShadowButtonMemoized = (value = '01') => props => (0, _styledSystem.boxShadow)(_objectSpread(_objectSpread({}, props), {}, {
...
const scaleButton = props => {
  ...
  const nextProps = _objectSpread(_objectSpread({}, props), {}, {
    pb,
    pl,
    pr,
    pt
...
Button.defaultProps = _objectSpread(_objectSpread({}, _styledHelpers.defaultStylesBase), {}, {
  bg: null,
  bgActiveColor: null,
  bgHoverColor: null,
