...
var Button = exports.Button = (0, _styledComponents2["default"])(_component.ButtonComponent)(_templateObject(), _styledSystem.alignContent, _styledSystem.alignItems, _styledSystem.alignSelf, borderButton, _styledHelpers.borderRadiusCore, _styledSystem.borderWidth, boxShadowButtonMemoized(), _styledSystem.bottom, _styledSystem.buttonStyle, _styledHelpers.colorCore, _styledSystem.display, _styledSystem.flexBasis, _styledSystem.flexDirection, _styledSystem.flexWrap, _styledHelpers.fontFamilyCore, _styledHelpers.fontSizeCore, _styledHelpers.fontStyleCore, _styledSystem.fontWeight, _styledSystem.height, _styledSystem.justifyContent, _styledSystem.left, _styledHelpers.letterSpacingCore, _styledSystem.lineHeight, _styledSystem.maxHeight, _styledSystem.maxWidth, _styledSystem.minHeight, _styledSystem.minWidth, _utils.positionButton, _styledSystem.right, scaleButton, _styledSystem.size, _styledHelpers.textAlignCore, _styledHelpers.textDecorationCore, _styledSystem.top, _styledSystem.width, _styledSystem.zIndex, _utils.hoverColorButton, boxShadowButtonMemoized('02'), _utils.activeColorButton);
