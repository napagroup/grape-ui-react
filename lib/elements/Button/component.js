...
const propsToTrim = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _styledHelpers.flexboxProps.propTypes), _styledHelpers.layoutProps.propTypes), _styledHelpers.positionProps.propTypes), _styledHelpers.spaceProps.propTypes), _styledHelpers.typography.propTypes), {}, {
  variant: _propTypes.default.string
});

const propsToTrimForButton = _objectSpread(_objectSpread(_objectSpread({}, propsToTrim), _styledSystem.boxShadow.propTypes), {}, {
...
const propsToTrimForLink = _objectSpread(_objectSpread(_objectSpread({}, propsToTrim), _styledSystem.boxShadow.propTypes), {}, {
  bgActiveColor: _propTypes.default.string,
  bgHoverColor: _propTypes.default.string,
  contained: false,
  outline: false,
