...
var ButtonComponent = exports.ButtonComponent = function ButtonComponent(_ref) {
  ...
  if (href) {
    output = _react2["default"].createElement("a", _extends({
      href: href
    }, trimmedPropsLink), _react2["default"].createElement("div", null, children));
  } else if (to) {
    var linkProps = {
      to: to
    };
    output = _react2["default"].createElement(_reactRouterDom.Link, _extends({}, trimmedPropsLink, linkProps), _react2["default"].createElement("div", null, children));
    ...
    output = _react2["default"].createElement("button", _extends({
      type: "button"
    }, (0, _componentHelpers.removeSomeProps)(props, Object.keys(propsToTrimForButton))), _react2["default"].createElement("div", null, children));
  }
