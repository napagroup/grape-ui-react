...
var renderControlGroupLabel = function renderControlGroupLabel(propsFromControlGroup) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(_utils.ControlLabel, labelProps, text);
};
...
var renderControlGroupAssistive = function renderControlGroupAssistive(propsFromControlGroup) {
  ...
  if (assistiveText && !error) {
    return /*#__PURE__*/_react2["default"].createElement(_utils.AssistiveText, _extends({
      id: "".concat(id, "Help")
...
var ControlGroupComponent = exports.ControlGroupComponent = function ControlGroupComponent(_ref) {
  ...
  return /*#__PURE__*/_react2["default"].createElement("div", (0, _componentHelpers.removeSomeProps)(props, propsToTrim), children, renderControlGroupLabel(labelProps), renderControlGroupAssistive(assistiveProps));
};
