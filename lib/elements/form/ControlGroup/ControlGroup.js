...
exports.ControlGroupBase = exports.ControlGroup = undefined;
...
var ControlGroupBase = function ControlGroupBase(props) {
  var activeColor = props.activeColor,
      ...
      validationError = props.validationError,
      otherProps = _objectWithoutProperties(props, ['activeColor', 'assistiveText', 'children', 'controlLabel', 'controlId', 'disabled', 'validationError']);
  ...
  var displayControlLabel = function displayControlLabel(text) {
    if (!text) {
      return null;
    }
    return _react2.default.createElement(
