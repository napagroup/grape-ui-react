...
var propsToTrim = ['activeColor', 'assistiveText', 'controlGroupProps', 'controlId', 'disabled', 'hideLabel', 'labelText', 'name', 'validationError'].concat(_toConsumableArray(Object.keys(_styledHelpers.spaceProps.propTypes)), _toConsumableArray(Object.keys(_styledHelpers.typography.propTypes)));
