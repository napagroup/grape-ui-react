...
var getActiveColor = function getActiveColor(props) {
  var activeColor = props.activeColor;

  if (!activeColor) {
    return (0, _componentHelpers.resolveColor)(defaultControlStylesBase.activeColor);
  }
  return (0, _componentHelpers.resolveColor)(activeColor);
};
