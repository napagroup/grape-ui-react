...
var CheckboxLabel = (0, _styledComponents2["default"])(CheckboxLabelComponent)(_templateObject(), _styledHelpers.colorCore, _styledHelpers.ellipsisCore, _styledHelpers.fontFamilyCore, _styledHelpers.fontSizeCore, _styledSystem.fontWeight, _styledHelpers.letterSpacingCore, _styledHelpers.lineHeightCore, _styledHelpers.fontStyleCore, _styledHelpers.textAlignCore, _styledHelpers.textDecorationCore, marginRight, opacity);
...
var Wrapper = function Wrapper(_ref2) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(_reactCheckboxGroup.CheckboxGroup, checkboxGroupProps, children);
};
...
var SingleCheckBox = function SingleCheckBox(props) {
  ...
  return /*#__PURE__*/_react2["default"].createElement(CheckboxLabel, _extends({
    key: "".concat(option.label, "-label")
  }, propsForCheckboxLabel), /*#__PURE__*/_react2["default"].createElement(_reactCheckboxGroup.Checkbox, _extends({
    key: option.label,
    disabled: disabled,
    id: option.value
...
var CheckboxFieldComponent = exports.CheckboxFieldComponent = function CheckboxFieldComponent(props) {
  ...
  if (plainText) {
    ...
    return /*#__PURE__*/_react2["default"].createElement(_utils.PlainText, plainTextProps);
  }
  ...
  return /*#__PURE__*/_react2["default"].createElement(CheckboxGroupWrapper, _extends({
    checkboxDepth: 2,
