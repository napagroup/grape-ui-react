...
var marginRight = function marginRight() {
  return 'margin-right: ' + (0, _styledHelpers.scaleFont)(gutter, 1);
};
...
var Wrapper = function Wrapper(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _extends({}, checkboxGroupProps, { assistiveText: (0, _AssistiveText.getAssistiveText)(props) }),
    children
  );
};
...
var SingleCheckBox = function SingleCheckBox(props) {
  ...
  var stylePropsForCheckBox = { cursor: 'pointer', marginRight: (0, _styledHelpers.scaleFont)(gutter, 0.5) };
  return _react2.default.createElement(
    CheckboxLabel,
