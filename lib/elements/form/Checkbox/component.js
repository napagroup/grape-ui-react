...
var Wrapper = function Wrapper(_ref2) {
  ...
  var propsToTrim = ['controlGroupProps', 'flexDirection'].concat(_toConsumableArray(Object.keys(_styledHelpers.spaceProps.propTypes)));
...
var propsToTrimLabel = ['controlId', 'plainText', 'name', 'onChange', 'option'];
...
var CheckboxFieldComponent = exports.CheckboxFieldComponent = function CheckboxFieldComponent(props) {
  ...
  if (plainText) {
    var plainTextProps = _objectSpread({
      value: value
    }, (0, _componentHelpers.removeSomeProps)(props, ['controlGroupProps', 'controlId', 'flexDirection', 'labelText', 'name', 'onChange', 'options', 'plainText', 'wrapperProps']));

    return _react2["default"].createElement(_PlainText.PlainText, plainTextProps);
  }

  var checkboxProps = (0, _componentHelpers.removeSomeProps)(props, ['controlGroupProps', 'controlId', 'plainText', 'name', 'onChange', 'options', 'flexDirection', 'wrapperProps']);
