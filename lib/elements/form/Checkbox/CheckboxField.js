...
var _ControlLabel = require('../../../elements/form/ControlGroup/ControlLabel');
...
var CheckboxField = function CheckboxField(props) {
  var activeColor = props.activeColor,
      ...
      otherProps = _objectWithoutProperties(props, ['activeColor', 'controlId', 'disabled', 'defaultValue', 'plainText', 'value', 'controlLabel', 'required', 'validationError']);
