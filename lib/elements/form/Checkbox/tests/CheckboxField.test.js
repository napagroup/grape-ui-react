...
describe('CheckboxField Component with custom assistive text props', function () {
  test.only('should return a CheckboxField that contains custom assistive text props', function () {
    var selectedValue = ['red'];
...
describe('CheckboxField Component with custom controlLabelProps', function () {
  test.only('should return a CheckboxField that contains custom controlLabelProps', function () {
    var selectedValue = ['red'];
