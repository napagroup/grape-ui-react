...
describe('CheckboxFieldComponent Component with assistive text', function () {
  it('should return a CheckboxFieldComponent that contains CheckboxComponent with assistive text', function () {
    var element = _react2.default.createElement(_.CheckboxField, { assistiveText: 'Tell me your color', controlId: 'exampleColor', labelText: 'Color', name: 'Color', options: colorOptions, required: true, value: '' });
    expect(assertReactElement(element)).toMatchSnapshot();
  });
});
describe('CheckboxFieldComponent Component with required', function () {
  it('should return a CheckboxFieldComponent that contains CheckboxComponent required', function () {
    var element = _react2.default.createElement(_.CheckboxField, { controlId: 'exampleColor', labelText: 'Color', name: 'Color', options: colorOptions, required: true, value: '' });
    expect(assertReactElement(element)).toMatchSnapshot();
  });
});
describe('CheckboxFieldComponent Component with validationError', function () {
  it('should return a CheckboxFieldComponent that contains CheckboxComponent validationError', function () {
    var selectedValue = ['red'];
    var element = _react2.default.createElement(_.CheckboxField, { assistiveText: '', controlId: 'exampleColor', labelText: 'Color', name: 'Color', options: colorOptions, required: true, validationError: 'This is required', value: selectedValue });
    expect(assertReactElement(element)).toMatchSnapshot();
  });
});
