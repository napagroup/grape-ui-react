...
var renderValueOrComponent = function renderValueOrComponent(propsFromComponent) {
  ...
  if (plainText) {
    var plainTextProps = Object.assign({
      value: value
    }, (0, _componentHelpers.removeSomeProps)(propsFromComponent, ['controlId', 'labelText', 'assistiveText', 'name', 'onChange', 'options', 'plainText', 'validationError', 'flexDirection']));
