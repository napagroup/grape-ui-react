...
var getDisplayValue = function getDisplayValue(props) {
  ...
  if (isArrayOptionsValue(value)) {
    var output = value.map(function (e) {
      return e.label;
    }).join(',');
    return output;
  }
...
var propsToTrim = [].concat(_toConsumableArray(Object.keys(_styledHelpers.control.propTypes)), _toConsumableArray(Object.keys(_styledHelpers.spaceProps.propTypes)), _toConsumableArray(Object.keys(_styledHelpers.typography.propTypes)), ['value']);
