...
var DateFieldComponent = exports.DateFieldComponent = _react2["default"].forwardRef(function (props, ref) {
  ...
  return _react2["default"].createElement(_DayPickerInput2["default"], _extends({
    ref: ref,
    format: format,
