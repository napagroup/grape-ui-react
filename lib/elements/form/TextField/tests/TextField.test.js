...
describe('TextField with a currency attribute', function () {
  ...
  test.skip('should return a TextField of input type currency', function () {
...
describe('TextField with a numeric attribute', function () {
  // TODO: Test should test actual formatted value or masking capabilities, not the mount snapshot
  test.skip('should return a TextField of input type numeric', function () {
    var component = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.TextField, {
      name: "numeric",
...
describe('TextField with an integer attribute', function () {
  // TODO: Test should test actual formatted value or masking capabilities, not the mount snapshot
  test.skip('should return a TextField of input type integer', function () {
    var component = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.TextField, {
      integer: true,
...
describe('TextField with a postalCode attribute', function () {
  // TODO: Test should test actual formatted value or masking capabilities, not the mount snapshot
  test.skip('should return a TextField of input type postalCode', function () {
    var component = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.TextField, {
      name: "postalCode",
...
describe('TextField with a phone attribute', function () {
  // TODO: Test should test actual formatted value or masking capabilities, not the mount snapshot
  test.skip('should return a TextField of input type phone', function () {
    var component = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.TextField, {
      name: "phone",
...
describe('TextField with a formatterOptions attribute', function () {
  // TODO: Test should test actual formatted value or masking capabilities, not the mount snapshot
  test.skip('should return a TextField with formatterOptions', function () {
    var option = {
      numeral: true,
