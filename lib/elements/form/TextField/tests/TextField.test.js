...
describe('TextField with validation error', function () {
  it('should return a TextField object contain Assistive Text with error style', function () {
    var component = (0, _enzyme.mount)(_react2.default.createElement(_.TextField, { controlId: 'exampleFullName', controlLabel: 'Full name', validationError: 'This is a require field.' }));
    expect((0, _enzymeToJson2.default)(component.find('TextField'))).toMatchSnapshot();
  });
});
describe('TextField with some other props', function () {
  it('should return a TextField object contain input with those other props ', function () {
    var component = (0, _enzyme.mount)(_react2.default.createElement(_.TextField, { controlId: 'exampleFullName', controlLabel: 'Full name', link: 'abc', require: true }));
    expect((0, _enzymeToJson2.default)(component.find('TextField'))).toMatchSnapshot();
  });
});
...
describe('TextField with a responsive width', function () {
  it('should return a TextFieldComponent object with a responsive width', function () {
    var component = (0, _enzyme.mount)(_react2.default.createElement(_.TextField, { controlId: 'exampleFullName', controlLabel: 'Full name', sm: true, width: [1, 1 / 2, 1 / 3, 1 / 4] }));
    expect((0, _enzymeToJson2.default)(component.find('TextField'))).toMatchSnapshot();
  });
});
describe('TextField a small TextFieldComponent object', function () {
