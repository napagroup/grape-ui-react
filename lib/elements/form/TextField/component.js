...
var propsToTrim = ['formStyle', 'labelText', 'plainText', 'validationError', 'email', 'password'].concat(_toConsumableArray(Object.keys(_styledHelpers.control.propTypes)), _toConsumableArray(Object.keys(_styledHelpers.typography.propTypes)));
