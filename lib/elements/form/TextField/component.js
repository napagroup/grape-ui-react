...
var TextInputComponent = exports.TextInputComponent = function TextInputComponent(_ref) {
  ...
  if (multiline) {
    return _react2["default"].createElement(_react2["default"].Fragment, null, _react2["default"].createElement("div", null), _react2["default"].createElement(_reactTextareaAutosize2["default"], _extends({
      maxRows: maxRows,
      readOnly: plainText,
      tabIndex: plainText ? '-1' : '0'
    }, (0, _componentHelpers.removeSomeProps)(props, propsToTrim))));
