...
var TextInputComponent = function TextInputComponent(_ref) {
  var plainText = _ref.plainText,
      ...
      props = _objectWithoutProperties(_ref, ['plainText', 'formStyle']);

  return (// Make sure formStyle no going into input tag
    _react2.default.createElement('input', _extends({ readOnly: plainText, tabIndex: plainText ? '-1' : '0', type: 'text' }, (0, _componentHelpers.passThrough)(TextInputComponent, props)))
  );
};
