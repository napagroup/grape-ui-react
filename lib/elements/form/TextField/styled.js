...
var propsToTrim = ['assistiveText', 'controlId', 'labelText', 'controlLabelProps', 'validationError'].concat(_toConsumableArray(Object.keys(_styledHelpers.spaceProps.propTypes)));
