...
var propsToTrim = ['bg', 'controlId', 'disabled', 'assistiveText', 'required', 'plainText'];
var plaintextPropsToTrim = ['controlId', 'assistiveText', 'validationError', 'required', 'formStyle'];
...
var SelectField = exports.SelectField = function SelectField(props) {
  ...
  }, renderValueOrComponent(_objectSpread({}, props, {
    formStyle: formStyle,
    labelText: labelText,
    plainText: plainText
  })));
