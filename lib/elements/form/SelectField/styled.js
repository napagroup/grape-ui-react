...
var propsToTrim = ['bg', 'controlGroupProps', 'controlId', 'disabled', 'assistiveText', 'required', 'plainText'];
var plaintextPropsToTrim = ['controlId', 'assistiveText', 'validationError', 'required', 'formStyle', 'controlGroupProps'];
