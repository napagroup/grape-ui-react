...
describe('SelectField Component dropdown', function () {
  it('should return a dropdown menu with the selected option is in the proper color', function () {
    var element = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.SelectField, {
...
describe('TextField with custom menu elevation', function () {
  it('should return a TextField with different zIndex and boxShadow values', function () {
    var element = _react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.SelectField, {
      assistiveText: "Please tell me your color",
...
describe('TextField with custom z-index', function () {
  it('should return a TextField with different zIndex than the menuElevation preset', function () {
    var element = _react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.SelectField, {
      assistiveText: "Please tell me your color",
