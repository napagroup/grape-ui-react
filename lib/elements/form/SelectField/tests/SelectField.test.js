...
describe('SelectField Component with only name provided', function () {
  it('should return a SelectField with name used in place of id', function () {
    var component = (0, _enzyme.mount)(_react2["default"].createElement(_styledComponents.ThemeProvider, {
      theme: {}
    }, _react2["default"].createElement(_.SelectField, {
      labelText: "Color",
...
describe('TextField with custom menu elevatiom', function () {
