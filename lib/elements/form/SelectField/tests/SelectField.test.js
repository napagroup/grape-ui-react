...
describe('SelectField Component with lg text', function () {
  ...
  it('should return a SelectField with activeColor', function () {
    var component = (0, _enzyme.mount)(_react2.default.createElement(_.SelectField, { activeColor: 'cyan', assistiveText: 'Please tell me your color', controlId: 'exampleColor', controlLabel: 'Color', defaultValue: colorOptions[1], id: 'exampleColor', options: colorOptions }));
    expect((0, _enzymeToJson2.default)(component.find('SelectField'))).toMatchSnapshot();
  });
});
