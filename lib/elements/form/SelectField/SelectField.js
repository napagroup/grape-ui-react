...
var SelectField = function SelectField(props) {
  ...
  var renderValueOrComponent = function renderValueOrComponent() {
    if (plainText) {
      ...
      var displayValue = value ? value.label : defaultValue.label;
    ...
    return _react2.default.createElement(_SelectFieldComponent.SelectFieldComponent, _extends({ validationError: validationError }, childProps, disableRelatedProps));
  };
  return _react2.default.createElement(
...
SelectField.defaultProps = {
  ...
  plainText: false,
  validationError: '',
  value: _componentHelpers.defaultOptions,
  defaultValue: _componentHelpers.defaultOptions
};