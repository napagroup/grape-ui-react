...
var SelectField = function SelectField(props) {
  var activeColor = props.activeColor,
      ...
      otherProps = _objectWithoutProperties(props, ['activeColor', 'bgColor', 'controlId', 'disabled', 'defaultValue', 'assistiveText', 'plainText', 'value', 'labelText', 'required', 'validationError']);
