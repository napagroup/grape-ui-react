...
var SelectField = function SelectField(props) {
  var activeColor = props.activeColor,
      ...
      otherProps = _objectWithoutProperties(props, ['activeColor', 'bgColor', 'controlId', 'disabled', 'assistiveText', 'controlLabel', 'required', 'plainText', 'validationError']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_SelectFieldComponent.SelectFieldComponent, _extends({ validationError: validationError }, childProps, disableRelatedProps))
  );
};
