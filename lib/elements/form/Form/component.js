...
var formComponentPropsToRemove = _objectSpread({}, _propTypes4["default"].flexbox, {}, _propTypes4["default"].layout, {}, _propTypes4["default"].position, {}, _propTypes4["default"].space, {
  formInline: false
});
...
var FormComponent = exports.FormComponent = function FormComponent(_ref) {
  ...
  if (!formStyle) {
    output = /*#__PURE__*/_react2["default"].createElement("form", (0, _componentHelpers.removeSomeProps)(props, Object.keys(formComponentPropsToRemove)), children);
  } else {
    var childrenWithProps = _react2["default"].Children.map(children, function (child) {
      return applyFormStyleToChild(child, formStyle);
    });

    output = /*#__PURE__*/_react2["default"].createElement("form", (0, _componentHelpers.removeSomeProps)(props, Object.keys(formComponentPropsToRemove)), childrenWithProps);
  }
