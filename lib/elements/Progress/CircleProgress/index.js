...
const stroke = (0, _utils.makeColorResolver)('stroke', 'strokeColor');
...
const Track = (0, _styledComponents.default)('circle')(_templateObject4(), stroke);
const StyledRoot = (0, _styledComponents.default)(_grid.Box)(_templateObject5(), circularRotate, (0, _styledSystem.system)({
  transform: true
}), _utils.styledSystemAnimation);
...
const getStyledRootProps = props => {
  ...
  return {
    animationDuration,
    animationIterationCount: (0, _utils.getAnimationIterationCount)(props),
...
const CircularProgress = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(StyledRoot, getStyledRootProps(props), /*#__PURE__*/_react.default.createElement(StyledSvg, {
    height: diameter,
    width: diameter
  }, /*#__PURE__*/_react.default.createElement(Track, (0, _extends2.default)({}, baseCircleProps, {
    strokeColor: getTrackColor(props)
  }, trackProps)), /*#__PURE__*/_react.default.createElement(Circle, (0, _extends2.default)({}, baseCircleProps, (0, _utils.getProgressProps)(progressProps), {
...
CircularProgress.propTypes = _objectSpread({}, _utils.progressBasePropTypes, {
  diameter: _propTypes.default.number,
  strokeWidth: _propTypes.default.number
});
CircularProgress.defaultProps = _objectSpread({}, _utils.progressBaseDefaultProps, {
  diameter: 35,
  strokeWidth: 5
});