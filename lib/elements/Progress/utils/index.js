...
_forEachInstanceProperty(_context = _Object$keys(_keyframes)).call(_context, function (key) {
...
_forEachInstanceProperty(_context3 = _Object$keys(_styledHelpers)).call(_context3, function (key) {
  if (key === "default" || key === "__esModule") return;
