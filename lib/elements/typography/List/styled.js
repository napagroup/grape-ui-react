...
const listComponentPropsToTrim = _objectSpread({}, _propTypes2.default.space, {}, _styledHelpers.typography.propTypes, {
...
const listFactory = factoryProps => {
  ...
  return (0, _styledComponents.default)((0, _Hideable.withHideable)(ListComponent))(_templateObject(), _styledHelpers.colorCore, _styledHelpers.ellipsisCore, _styledHelpers.fontFamilyCore, _styledHelpers.fontSizeCore, _styledSystem.fontWeight, _styledHelpers.letterSpacingCore, _styledHelpers.lineHeightCore, _styledHelpers.fontStyleCore, _styledHelpers.textAlignCore, _styledHelpers.textDecorationCore, margin, paddingLeft, listStyle, inlineStyle, _styledSystem.space);
};
