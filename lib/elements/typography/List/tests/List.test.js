...
describe('List Component', function () {
  it('should return a List object with base styling', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.List, null, "Lorem Ipsum"));

    var tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });
  it('should return a List object with font-style: italic', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.List, {
      italic: true
    }, "Lorem Ipsum"));
...
describe('Numbered List Component', function () {
  it('should return a Numbered List object with base styling', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.List.ol, null, "Lorem Ipsum"));

    var tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });
  it('should return a Numbered List object with font-style: italic', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.List.ol, {
      italic: true
    }, "Lorem Ipsum"));
