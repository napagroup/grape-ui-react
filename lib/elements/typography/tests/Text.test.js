...
describe('Text Component', function () {
  ...
  it('should return a Text object with font-family: serif', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(
      _Text.Text,
      { fontFamily: 'serif' },
      'Lorem Ipsum'
  ...
  it('should return a Text object with kerning: 1px', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(
      _Text.Text,
      { kerning: '1px' },
      'Lorem Ipsum'
  ...
  it('should return a Text object with text-align: right', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(
      _Text.Text,
      { textAlign: 'right' },
      'Lorem Ipsum'
