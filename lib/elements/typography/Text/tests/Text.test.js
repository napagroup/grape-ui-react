...
describe('Text Component base', function () {
  it('should return a Text object with base styling', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Text, null, "Lorem Ipsum"));
...
describe('Text Component specified styles', function () {
  it('should return a Text object with a specified color', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Text, {
      color: "green.light"
    }, "Lorem Ipsum"));
