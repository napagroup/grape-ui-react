...
var listFactory = function listFactory(props) {
  ...
  var paddingLeft = '2.5rem';
  var listStyle = '';
  if (unstyled) {
    paddingLeft = '0';
    listStyle = 'list-style: none;';
  };
  var ProtoList = _styledComponents2.default[listTag](_templateObject, (0, _textStyles.textStylesBase)({}), gridSchema.gutter, paddingLeft, listStyle);
