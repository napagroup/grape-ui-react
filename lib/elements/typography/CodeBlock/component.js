...
const CodeBlockComponent = (_ref) => {
  let codeString = _ref.codeString,
      language = _ref.language,
      style = _ref.style,
      props = (0, _objectWithoutProperties2.default)(_ref, ["codeString", "language", "style"]);
  return /*#__PURE__*/_react.default.createElement(_reactSyntaxHighlighter.default, (0, _extends2.default)({
    language: language,
    style: style
  }, (0, _componentHelpers.removeSomeProps)(props, (0, _keys.default)(_utils.codeBlockPropTypes))), codeString);
};
