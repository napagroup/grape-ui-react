...
const getHeaderFontSizeFromTag = factoryProps => {
  ...
  const getHeaderFontSizeMemoized = props => {
    ...
    const overrides = _objectSpread({}, props, {
...
const propsToTrim = _objectSpread({}, _styledHelpers.spaceProps.propTypes, {}, _styledHelpers.typography.propTypes, {
...
const headerFactory = factoryProps => {
  ...
  return (0, _styledComponents.default)((0, _Hideable.withHideable)(HeaderComponent))(_templateObject(), _styledHelpers.colorCore, _styledHelpers.ellipsisCore, _styledHelpers.fontFamilyCore, _styledHelpers.fontStyleCore, getHeaderFontSize, getHeaderFontWeight, _styledHelpers.letterSpacingCore, _styledHelpers.lineHeightCore, _styledHelpers.textAlignCore, _styledHelpers.textDecorationCore, _styledSystem.space);
};
