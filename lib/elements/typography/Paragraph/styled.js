...
const fontSizeParagraph = props => {
  ...
  return lead ? (0, _styledHelpers.fontSizeCore)(_objectSpread(_objectSpread({}, props), {}, {
    lg: true
...
const fontWeightParagraph = props => {
  const lead = props.lead;
  return lead ? (0, _styledSystem.fontWeight)(_objectSpread(_objectSpread({}, props), {}, {
    fontWeight: '300'
...
Paragraph.propTypes = _objectSpread(_objectSpread({}, _styledHelpers.typography.propTypes), {}, {
  /** Use the lead font size */
  lead: _propTypes.default.bool
});
Paragraph.defaultProps = _objectSpread(_objectSpread({}, _styledHelpers.defaultStylesBase), {}, {
  lead: false,
