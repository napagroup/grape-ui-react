...
var fontSizeParagraph = function fontSizeParagraph(props) {
  ...
  return lead ? (0, _styledHelpers.fontSizeCore)(Object.assign({}, props, { lg: true })) : (0, _styledHelpers.fontSizeCore)(props);
};
var fontWeightParagraph = function fontWeightParagraph(props) {
  var lead = props.lead;

  return lead ? (0, _styledSystem.fontWeight)(Object.assign({}, props, { fontWeight: '300' })) : (0, _styledSystem.fontWeight)(props);
};
...
Paragraph.propTypes = Object.assign({}, _styledHelpers.typography.propTypes, {
  lead: _propTypes2.default.bool
});

Paragraph.defaultProps = Object.assign({}, _styledHelpers.defaultStylesBase, {
  lead: false
});
