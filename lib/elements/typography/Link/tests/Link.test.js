...
describe('Link Component base', function () {
  it('should return an anchor tag', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Link, null, "Lorem Ipsum"));

    var tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });
  it('should return an anchor tag with an href, given the href attribute', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Link, {
      href: "./home"
    }, "Lorem Ipsum"));
  ...
  it('should return a react router tag, given a \'to\' attribute', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_reactRouterDom.MemoryRouter, null, _react2.default.createElement(_.Link, {
      to: "./home"
    }, "Lorem Ipsum")));
