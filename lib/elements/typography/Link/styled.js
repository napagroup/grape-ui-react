...
exports.Link = Link;
Link.propTypes = _objectSpread(_objectSpread({}, _styledHelpers.typography.propTypes), {}, {
...
Link.defaultProps = _objectSpread(_objectSpread({}, _styledHelpers.defaultStylesBase), {}, {
  color: 'brandLink',
  emailHref: {},
