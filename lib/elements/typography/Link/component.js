...
const LinkComponent = (_ref) => {
  ...
  const trimmedProps = (0, _componentHelpers.removeSomeProps)(props, (0, _keys.default)(_objectSpread(_objectSpread({}, _styledHelpers.spaceProps.propTypes), _styledHelpers.typography.propTypes)));
