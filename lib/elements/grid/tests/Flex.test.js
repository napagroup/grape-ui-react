...
describe('Flex', function () {
  ...
  describe('Component with specified margins', function () {
  ...
  describe('Component with specified padding', function () {
  ...
  describe('Component with specified widths', function () {
  ...
  describe('Component with specified layout properties', function () {
  ...
  describe('Component with specified alignment properties', function () {
...
describe('Flex Component using custom theme breakpoints', function () {
  /*
