...
describe('Flex base', function () {
  it('should return a Flex object with base styling', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Flex, null, "Lorem Ipsum"));

    var tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });
  it('should return a Flex object with a box element as the child', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Flex, null, _react2.default.createElement(_.Box, null, "Lorem Ipsum")));

    var tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });
  it('should return a Flex object with 2 responsive Box elements as the children', function () {
    var component = _reactTestRenderer2.default.create(_react2.default.createElement(_.Flex, {
      alignItems: "flex-start",
      flexWrap: "wrap"
    }, _react2.default.createElement(_.Box, {
      width: [1, 1 / 3]
    }, "Lorem"), _react2.default.createElement(_.Box, {
      width: [1, 2 / 3]
    }, "Ipsum")));
