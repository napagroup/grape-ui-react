...
const cardPropTypes = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, cardActionsBasePropTypes), cardBasePropTypes), cardBodyBasePropTypes), cardHeaderBasePropTypes), cardInnerBasePropTypes), cardRichMediaBasePropTypes), cardSecondaryMediaBasePropTypes), {}, {
  children: _propTypes.default.node
});

exports.cardPropTypes = cardPropTypes;

const cardDefaultProps = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, cardActionsBaseDefaultProps), cardBaseDefaultProps), cardBodyBaseDefaultProps), cardHeaderBaseDefaultProps), cardInnerBaseDefaultProps), cardRichMediaBaseDefaultProps), cardSecondaryMediaBaseDefaultProps), {}, {
  background: 'white',
