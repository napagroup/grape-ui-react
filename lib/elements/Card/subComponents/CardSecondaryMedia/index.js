...
var _subComponents = require("../../../../elements/Card/subComponents");
...
const getCardSecondaryMedia = props => {
  ...
  if (cardSecondaryMedia) {
    return /*#__PURE__*/_react.default.createElement(_grid.Box, {
      ...
      pb: cardBody || (0, _CardActions.getCardActions)(props) ? cardPadding : ''
    }, cardSecondaryMediaProps), cardSecondaryMedia), (0, _subComponents.getCardBody)(props));
  }
...
getCardSecondaryMedia.propTypes = _objectSpread(_objectSpread({}, _utils.cardBasePropTypes), _utils.cardSecondaryMediaBasePropTypes);
getCardSecondaryMedia.defaultProps = _objectSpread(_objectSpread({}, _utils.cardBaseDefaultProps), _utils.cardSecondaryMediaBaseDefaultProps);