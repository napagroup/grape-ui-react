...
const Card = (0, _styledComponents.default)((0, _Hideable.withHideable)(_component.CardComponent))(_templateObject());
exports.Card = Card;
...
(0, _forEach.default)(subComponentStarter).call(subComponentStarter, starter => {
  ...
  Card[name].propTypes = _objectSpread({}, componentPropTypes, {
    children: _propTypes.default.node
  });
  Card[name].defaultProps = _objectSpread({}, componentDefaultProps, {
    children: ''
  });
});
/** @component */