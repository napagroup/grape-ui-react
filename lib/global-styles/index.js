...
var getGlobalStyles = exports.getGlobalStyles = function getGlobalStyles() {
  ...
  if (overrides instanceof Object && !Array.isArray(overrides)) {
    var _overrides$border = overrides.border,
        ...
        buttonVariantOverrides = _overrides$buttonVari === undefined ? {} : _overrides$buttonVari,
    ...
    return {
      ...
      buttonVariant: Object.assign({}, buttonVariant, buttonVariantOverrides),
 ...
 */
var getGlobalOverrides = exports.getGlobalOverrides = function getGlobalOverrides(props) {
  return getGlobalStyles({
