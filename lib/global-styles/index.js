...
const getGlobalStyles = (overrides = {}) => {
  if (overrides instanceof Object && !(0, _isArray.default)(overrides)) {
    ...
    return {
      border: _objectSpread(_objectSpread({}, border), borderOverrides),
      breakpoints: _objectSpread(_objectSpread({}, breakpoints), breakpointOverrides),
      buttonVariant: _objectSpread(_objectSpread({}, buttonVariant), buttonVariantOverrides),
      colors: _objectSpread(_objectSpread({}, colors), colorsOverrides),
      fontFamily: _objectSpread(_objectSpread({}, fontFamily), fontFamilyOverrides),
      fontSize: _objectSpread(_objectSpread({}, fontSize), fontSizeOverrides),
      grid: _objectSpread(_objectSpread({}, grid), gridOverrides),
      shadow: _objectSpread(_objectSpread({}, shadow), shadowOverrides),
      zIndex: _objectSpread(_objectSpread({}, zIndex), zIndexOverrides)
    };
  }
