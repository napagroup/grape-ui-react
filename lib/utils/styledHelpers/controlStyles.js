...
exports.controlStyles = exports.disabledStyle = exports.focusStyles = exports.controlColor = undefined;
...
var getFinalStyle = function getFinalStyle(props) {
  ...
  var filledPadding = "".concat(Number.parseInt(padding, 10) * 1.5, "rem ").concat(padding, " ").concat(Number.parseInt(padding, 10) / 2, "rem");
