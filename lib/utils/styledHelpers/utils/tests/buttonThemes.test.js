...
describe('When given null (falsy)', () => {
  let expected = null;
  beforeEach(() => {
    expected = _objectSpread(_objectSpread(_objectSpread({}, plainVariants), containedVariants), magicVariants);
    mockGlobalStyles.getGlobalStyles = jest.fn().mockReturnValue({
      buttonVariant,
      colors
    });
...
describe('When given an array of types', () => {
  let expected = null;
  beforeEach(() => {
    expected = _objectSpread(_objectSpread({}, plainVariants), containedVariants);
    mockGlobalStyles.getGlobalStyles = jest.fn().mockReturnValue({
      buttonVariant,
      colors
    });
