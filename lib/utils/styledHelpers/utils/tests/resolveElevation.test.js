...
const inheritExpected = (0, _concat.default)(_context = "z-index: ".concat(_cssDefaults.CSS_INHERIT_VALUE, "; box-shadow: ")).call(_context, _cssDefaults.CSS_INHERIT_VALUE);
