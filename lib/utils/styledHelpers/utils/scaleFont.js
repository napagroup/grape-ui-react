...
var scaleFont = exports.scaleFont = function scaleFont(size, factor) {
  ...
  var floatScaleFactor = parseFloat(factor) || 1;
  var unit = size ? getUnit(size, defaultUnit) : defaultUnit;
