...
const plaintextPropsToTrim = ['assistiveText', 'assistiveTextProps', 'calendarOnly', 'controlColorProps', 'controlGroupProps', 'controlHeight', 'controlLabelProps', 'controlId', 'dayPickerProps', 'disabled', 'inputProps', 'inputRef', 'isClearable', 'isCreatable', 'isMulti', 'isHidden', 'isRequired', 'menuAlignment', 'menuDirection', 'menuDirectionViewportBreakpoint', 'menuElevation', 'menuOverlayBottom', 'menuOverlayLeft', 'menuOverlayRight', 'menuOverlayTop', 'menuPlacement', 'menuZIndex', 'multiline', 'styleOverrides', 'validationError', 'valueFormat'];
