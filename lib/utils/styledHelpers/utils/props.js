...
export var refType = PropTypes.oneOfType([PropTypes.func, PropTypes.object]);
export var typography = {
  propTypes: {
    ...
    ellipsis: PropTypes.oneOfType([PropTypes.bool, PropTypes.number]),
...
export var plaintextPropsToTrim = ['assistiveText', 'assistiveTextProps', 'calendarOnly', 'controlColorProps', 'controlGroupProps', 'controlHeight', 'controlLabelProps', 'controlId', 'dayPickerProps', 'disabled', 'inputProps', 'inputRef', 'isClearable', 'isCreatable', 'isMulti', 'isRequired', 'menuAlignment', 'menuDirection', 'menuDirectionViewportBreakpoint', 'menuElevation', 'menuOverlayBottom', 'menuOverlayLeft', 'menuOverlayRight', 'menuOverlayTop', 'menuPlacement', 'menuZIndex', 'multiline', 'styleOverrides', 'validationError', 'valueFormat'];