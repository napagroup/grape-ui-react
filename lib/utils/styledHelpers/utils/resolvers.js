...
var resolveColor = exports.resolveColor = function resolveColor(colorToResolve, globalOverrides) {
  ...
  var resolvedValue = (0, _objectHelpers.isKeyNestedProp)(colorToResolve) ? (0, _objectHelpers.resolveToProperty)(colorToResolve, colorSchema) : (0, _objectHelpers.resolveToProperty)(colorToResolve + '.base', colorSchema);
