...
const resolveBaseColor = (colorToResolve, colorSchema) => {
  const value = (0, _objectHelpers.resolveToProperty)("".concat(colorToResolve, ".base"), colorSchema);
  return value || (0, _objectHelpers.resolveToProperty)("".concat(colorToResolve), colorSchema);
};
...
const resolveColor = (colorToResolve, globalOverrides, defaultColor = _.defaultStylesBase.color) => {
  ...
  const resolvedValue = (0, _objectHelpers.isKeyNestedProp)(colorToResolve) ? (0, _objectHelpers.resolveToProperty)(colorToResolve, colorSchema) : resolveBaseColor(colorToResolve, colorSchema);
