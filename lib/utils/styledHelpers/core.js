...
const letterSpacingCore = props => (0, _styledSystem.letterSpacing)(_objectSpread(_objectSpread({}, props), {}, {
  letterSpacing: props.kerning || _cssDefaults.defaultStylesBase.kerning
}));

exports.letterSpacingCore = letterSpacingCore;

const lineHeightCore = props => (0, _styledSystem.lineHeight)(_objectSpread(_objectSpread({}, props), {}, {
  lineHeight: props.lineHeight || _cssDefaults.defaultStylesBase.lineHeight
}));

exports.lineHeightCore = lineHeightCore;

const fontStyleCore = props => "".concat(props.italic ? 'font-style: italic;' : '');

exports.fontStyleCore = fontStyleCore;

const textAlignCore = props => (0, _styledSystem.textAlign)(_objectSpread(_objectSpread({}, props), {}, {
  textAlign: props.textAlign || _cssDefaults.defaultStylesBase.textAlign
}));

exports.textAlignCore = textAlignCore;

const textDecorationCore = props => "text-decoration: ".concat(props.textDecoration || _cssDefaults.defaultStylesBase.textDecoration, ";");
